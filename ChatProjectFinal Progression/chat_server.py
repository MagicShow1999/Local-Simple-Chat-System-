...
#==============================================================================
                ...
                mes_time = time.strftime('%H:%M:%S', time.localtime()) + " " + mes

                self.indices[from_name].add_msg_and_index(mes_time)
                ...
                for g in the_guys:
                    ...
                    #--- your code here ----#
                  #  pass
                    mysend(to_sock, json.dumps({"action":"exchange", "from":from_name, "message" : mes}))
...
#==============================================================================
                ...
                poem_1 = self.sonnet.get_poem(int(idx))
                poem = ''
                for i in poem_1:
                    poem += i
...
#==============================================================================
                ...
                #--- your code here ----#
                search_rslt = [] 
                for name in self.indices.keys():    #clients' names
                    #list of result searched in "name" e.g. amber
                    l = self.indices[name].search(msg["target"])   #class Index
                    
                    
                    
                    for i in range(len(l)):
                        search_rslt.append('(' + str(name) + ')' + l[i][1])
               ...
               # search_rslt = "needs to use self.indices search to work"
                ...
                #--- end of your code---#
                mysend(from_sock, json.dumps({"action":"search", "results":str(search_rslt)}))
